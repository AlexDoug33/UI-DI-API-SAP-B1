Demystifying the Creation of Add-ons for SAP Business One with C# and B1Studio Integrated with Visual Studio.

Examples of all components available in the user interface API.

Creating a single installer for SQL and HANA versions, compatible with x86/x64 and executable in the B1 WebClient.
